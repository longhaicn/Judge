...
public class LoginAspectj {
    ...
    /**
     * 管理员接口管理切点 拦截验证GoodsController类的所有有以request为第一个参数的方法 除了getGoods方法
     */
//    @Pointcut("args(request,response,..) "
//    		+ "&& !execution(* com.judge.controller.AdminController.adminLogin(..))")
//    public void admin(HttpServletRequest request,HttpServletResponse response){}
	 ...
	 * @return
	 */
//    @Around("admin(request,response)")
//    public Object admin_around(ProceedingJoinPoint joinpoint,HttpServletRequest request,HttpServletResponse response) {
//        Object result = null;
//        try {
//            System.out.println("AdminAspectj-环绕通知开始"+request);
//            HttpSession session = request.getSession();
//            if (session.getAttribute("current_user") != null) {
//                try {
//                    result = joinpoint.proceed(joinpoint.getArgs());
...
//        } catch (Throwable t) {
//        	t.printStackTrace();
//            System.out.println("AdminAspectj-出现错误");
//        }
//        System.out.println("AdminAspectj-环绕通知结束");
//        return result;
//    }
}